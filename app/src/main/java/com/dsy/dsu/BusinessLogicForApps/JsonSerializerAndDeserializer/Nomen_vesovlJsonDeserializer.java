 ...
 return  РезультатОперацииBurkUPDATE.size();
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("namefull").asText().trim());//"date_update"
            sqLiteStatementInsert.bindString(3, jsonNodeParentMAP.get("articul").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(4, jsonNodeParentMAP.get("koeff").intValue());//"uuid"
            sqLiteStatementInsert.bindLong(5, jsonNodeParentMAP.get("type_material").intValue());//"uuid"
            ...
            sqLiteStatementInsert.bindLong(8, jsonNodeParentMAP.get("edizm").intValue());//"uuid"
