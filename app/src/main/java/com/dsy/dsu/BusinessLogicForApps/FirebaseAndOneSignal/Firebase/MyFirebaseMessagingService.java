package com.dsy.dsu.BusinessLogicForApps.FirebaseAndOneSignal.Firebase;
...
import com.dsy.dsu.BusinessLogicForApps.FirebaseAndOneSignal.OneSignal.registOnesignal.ClassOneSingnalGenerator;
  ...
  private ClassOneSingnalGenerator class__oneSingnalGenerator;
    ...
    public MyFirebaseMessagingService() {
        ...
        Log.w(this.getClass().getName(), " MyFirebaseMessagingService ПРИШЛО СООБЩЕНИЕ УВЕДОМЛЕНИЯ  С САЙТА ONESIGNAL !!!!!!!!!!!!  MyFirebaseMessagingService   metod onNewToken "+
                 " class__oneSingnalGenerator " + class__oneSingnalGenerator);
    } catch (Exception e) {
        e.printStackTrace();
   ...
   @Override
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
      super.onMessageReceived(remoteMessage);
        try{
            class__oneSingnalGenerator =    new ClassOneSingnalGenerator(getApplication());
