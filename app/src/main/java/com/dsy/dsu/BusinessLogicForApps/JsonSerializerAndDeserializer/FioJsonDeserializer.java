 ...
 return  РезультатОперацииBurkUPDATE.size();
            ...
            this.context=context;
                // ОперацияInsert = Create_Database_СамаБАзаSQLite.insert(имяТаблицаAsync, null, ТекущийАдаптерДляВсего);
                    ...
                    String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync+"  " +
                            " (  name, f,  n,o,BirthDate,snils,date_update,user_update,uuid,current_organization,current_table,prof) " +
                            "   VALUES (?,?,?  ,?,?,?," +
                            " ?,?,?  ,?,?,?);";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            // TODO: 25.09.2024 "f"
            if (  jsonNodeParentMAP.has("f") ) {
                if (!jsonNodeParentMAP.get("f").isNull()  ) {
                    sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("f").asText());//"name"
                }else {
            ...
            // TODO: 25.09.2024 "n"
            if (  jsonNodeParentMAP.has("n") ) {
                if (!jsonNodeParentMAP.get("n").isNull()  ) {
                    sqLiteStatementInsert.bindString(3, jsonNodeParentMAP.get("n").asText());//"name"
                }else {
            ...
            // TODO: 25.09.2024 "o"
            if (  jsonNodeParentMAP.has("o") ) {
                if (!jsonNodeParentMAP.get("o").isNull()  ) {
                    sqLiteStatementInsert.bindString(4, jsonNodeParentMAP.get("o").asText());//"name"
                }else {
            ...
            // TODO: 25.09.2024  
            sqLiteStatementInsert.bindString(5, jsonNodeParentMAP.get("BirthDate").asText());//"name"


            // TODO: 25.09.2024 "o"
            if (  jsonNodeParentMAP.has("snils") ) {
                if (!jsonNodeParentMAP.get("snils").isNull()  ) {
                    sqLiteStatementInsert.bindString(6, jsonNodeParentMAP.get("snils").asText());//"name"
                }else {
            ...
            sqLiteStatementInsert.bindLong(8, jsonNodeParentMAP.get("user_update").intValue());//"user_update"
            sqLiteStatementInsert.bindLong(9, jsonNodeParentMAP.get("uuid").longValue());//"uuid"
            sqLiteStatementInsert.bindLong(10, jsonNodeParentMAP.get("current_organization").intValue());//"user_update"
    ...
    private SQLiteStatement методGetSqliteStatementForUpdate(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            // TODO: 04.07.2023 цикл данных
            sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("name").asText().trim());//"name"
            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("f").asText().trim());//"name"
            sqLiteStatementInsert.bindString(3, jsonNodeParentMAP.get("n").asText().trim());//"name"
            sqLiteStatementInsert.bindString(4, jsonNodeParentMAP.get("o").asText().trim());//"name"
            sqLiteStatementInsert.bindString(5, jsonNodeParentMAP.get("BirthDate").asText().trim());//"name"



            // TODO: 02.10.2024 snils
            if (jsonNodeParentMAP.has("snils")) {

                    sqLiteStatementInsert.bindLong(6, jsonNodeParentMAP.get("snils").intValue());//"user_update"
                }else {
                    sqLiteStatementInsert.bindNull(6);
                }
            ...
            sqLiteStatementInsert.bindLong(13,jsonNodeParentMAP.get("uuid").longValue());//"uuid уже для UUID"
