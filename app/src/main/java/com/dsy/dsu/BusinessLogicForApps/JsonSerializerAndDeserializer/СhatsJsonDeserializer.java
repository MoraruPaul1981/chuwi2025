 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync+"" +
                        " (   user_update, date_update ,uuid ,  id_user,name,      current_table,  uuid_parent  )" +
                        " VALUES(?,?,?,?,?,?,?);";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(1, jsonNodeParentMAP.get("user_update").intValue());//"uuid"
            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("date_update").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("uuid").longValue());//"uuid"
            sqLiteStatementInsert.bindLong(4, jsonNodeParentMAP.get("id_user").intValue());//"uuid"
            sqLiteStatementInsert.bindString(5, jsonNodeParentMAP.get("name").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(6, jsonNodeParentMAP.get("current_table").longValue());//"current_table"
            sqLiteStatementInsert.bindLong(7, jsonNodeParentMAP.get("uuid_parent").longValue());//"current_table"
    ...
    private SQLiteStatement методGetSqliteStatementForUpdate(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("uuid").longValue());//"uuid"
            sqLiteStatementInsert.bindLong(4, jsonNodeParentMAP.get("id_user").intValue());//"uuid"
            sqLiteStatementInsert.bindString(5, jsonNodeParentMAP.get("name").asText());//"date_update"
            sqLiteStatementInsert.bindLong(6, jsonNodeParentMAP.get("current_table").longValue());//"current_table"
