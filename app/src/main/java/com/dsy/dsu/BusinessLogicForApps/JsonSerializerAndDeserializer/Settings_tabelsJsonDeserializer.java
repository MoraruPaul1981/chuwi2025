 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync+
                        " (  date_update,  user_update,version_dsu1  , organizations,uuid ,current_table,onesignal )  "
                        +" VALUES(?,?,?,?,?,?,?);";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("date_update").asText());//"date_update"
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("user_update").intValue());//"user_update"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("version_dsu1").intValue());//"user_update"
            sqLiteStatementInsert.bindLong(4, jsonNodeParentMAP.get("organizations").intValue());//"user_update"
            ...
            sqLiteStatementInsert.bindString(7, jsonNodeParentMAP.get("onesignal").asText());//"name"
