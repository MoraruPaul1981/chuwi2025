 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync+
                        " ( name_templates,user_update, date_update,uuid,status_send, current_table  )  "
                        +" VALUES(?,?,?  ,?,?,? );";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("name_templates").asText());//"date_update"
            ...
            sqLiteStatementInsert.bindLong(5, jsonNodeParentMAP.get("status_send").intValue());//"user_update"
