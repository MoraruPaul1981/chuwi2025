 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync+" " +
                        " (   cfo, month_tabels ,year_tabels,   date_update,  uuid,status_send,  user_update,    current_table   ) " +
                        " VALUES(?,?,?,?,?,?,?,?);";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(1, jsonNodeParentMAP.get("cfo").intValue());//"id""
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("month_tabels").intValue());//"id""
            ...
            sqLiteStatementInsert.bindLong(6, jsonNodeParentMAP.get("status_send").intValue());//"id""
