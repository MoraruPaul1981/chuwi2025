 ...
 return  РезультатОперацииBurkUPDATE.size();
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
           ...
           // sqLiteStatementInsert.bindLong(1, jsonNodeParentMAP.get("id").intValue());//"id""
            ...
            if (jsonNodeParentMAP.has("name")) {
                sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("name").asText());//"date_update"
            }else {
                sqLiteStatementInsert.bindNull(1);
            }


            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("fullname").asText().trim());//"date_update"
            ...
            sqLiteStatementInsert.bindLong(5, jsonNodeParentMAP.get("dir").intValue());//"date_update"
            ...
            if (jsonNodeParentMAP.has("owner")) {
                sqLiteStatementInsert.bindString(8, jsonNodeParentMAP.get("owner").asText());//"date_update"
            }else {
                sqLiteStatementInsert.bindNull(8);
            }



            if (jsonNodeParentMAP.has("vid_tc")) {
                sqLiteStatementInsert.bindString(9, jsonNodeParentMAP.get("vid_tc").asText());//"date_update"
            }else {
                sqLiteStatementInsert.bindNull(9);
            }
    ...
    private SQLiteStatement методGetSqliteStatementForUpdate(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            // TODO: 04.07.2023 цикл данных
            //sqLiteStatementInsert.bindLong(1, jsonNodeParentMAP.get("id").intValue());//"id""
            sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("name").asText().trim());//"date_update"
            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("fullname").asText().trim());//"date_update"
            sqLiteStatementInsert.bindString(3, jsonNodeParentMAP.get("date_update").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(4, jsonNodeParentMAP.get("user_update").intValue());//"uuid"
            sqLiteStatementInsert.bindLong(5, jsonNodeParentMAP.get("dir").intValue());//"date_update"
            sqLiteStatementInsert.bindLong(6, jsonNodeParentMAP.get("uuid").longValue());//"uuid"
            sqLiteStatementInsert.bindLong(7, jsonNodeParentMAP.get("current_table").longValue());//"current_table"
            sqLiteStatementInsert.bindLong(8, jsonNodeParentMAP.get("owner").intValue());//"date_update"


            if (  jsonNodeParentMAP.has("vid_tc")  ) {
                sqLiteStatementInsert.bindLong(9, jsonNodeParentMAP.get("vid_tc").intValue());//"date_update"
            }else{
                sqLiteStatementInsert.bindNull(9);
            }
