 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  " REPLACE INTO "+имяТаблицаAsync+
                        " (  message,date_start,clock, date_update,rights , uuid , current_table,status_write  ,uuid_notifications,type_tasks,head_message , callsback_note_task , alreadyshownnotifications    )  "
                        +" VALUES ( ?,?,?, ?,?,?  ,?,?,? , "+
                        " ?,?,?  ,?  "+
                  ") ;";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("message").asText().trim());//"date_update"
            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("date_start").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("clock").intValue());//"uuid"
            sqLiteStatementInsert.bindString(4, jsonNodeParentMAP.get("date_update").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(5, jsonNodeParentMAP.get("rights").intValue());//"uuid"
            ...
            sqLiteStatementInsert.bindLong(8, jsonNodeParentMAP.get("status_write").intValue());//"uuid"
            sqLiteStatementInsert.bindLong(9, jsonNodeParentMAP.get("uuid_notifications").longValue());//"uuid"
            sqLiteStatementInsert.bindString(10, jsonNodeParentMAP.get("type_tasks").asText().trim());//"date_update"
            sqLiteStatementInsert.bindString(11, jsonNodeParentMAP.get("head_message").asText().trim());//"date_update"
            sqLiteStatementInsert.bindString(12, jsonNodeParentMAP.get("callsback_note_task").asText());//"date_update"
            sqLiteStatementInsert.bindLong(13, jsonNodeParentMAP.get("alreadyshownnotifications").intValue());//"uuid"
