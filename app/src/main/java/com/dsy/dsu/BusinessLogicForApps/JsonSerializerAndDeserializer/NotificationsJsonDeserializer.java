 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync
                        + " (  date_start,  clock,date_update  , rights,uuid ,current_table,id_user,user_update  )  "
                        +" VALUES(?,?,?,  ?,?,?,  ?,?);";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            if (jsonNodeParentMAP.has("date_start")) {
                sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("date_start").asText());//"date_update"
            }else {
                sqLiteStatementInsert.bindNull(1);
            }


            if (jsonNodeParentMAP.has("clock")) {
                sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("clock").asText());//"date_update"
            }else {
            ...
            if (jsonNodeParentMAP.has("rights")) {
                sqLiteStatementInsert.bindString(5, jsonNodeParentMAP.get("rights").asText());//"date_update"
            }else {
            ...
            sqLiteStatementInsert.bindLong(8, jsonNodeParentMAP.get("id_user").intValue());//"name"
    ...
    private SQLiteStatement методGetSqliteStatementForUpdate(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            if (jsonNodeParentMAP.has("id_user")) {
                sqLiteStatementInsert.bindString(8, jsonNodeParentMAP.get("id_user").asText());//"date_update"
            }else {
