 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "REPLACE INTO "+имяТаблицаAsync+"" +
                        "  (  name, rights ,telephone , date_update,     current_table ,  locked , uuid )    " +
                        " VALUES (?,?,?,?,?,?,?);";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
          ...
          //  sqLiteStatementInsert.bindLong(1, jsonNodeParentMAP.get("id").intValue());//"id""
            ...
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("rights").intValue());//"uuid"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("telephone").intValue());//"uuid"



            // TODO: 25.09.2024 HAS uuid
            if (  jsonNodeParentMAP.has("date_update") ) {
                if (!jsonNodeParentMAP.get("date_update").isNull()) {
            ...
            Boolean СтатусБлокировки=jsonNodeParentMAP.get("locked").booleanValue();
            sqLiteStatementInsert.bindString(6, СтатусБлокировки.toString());//"uuid"
    ...
    private SQLiteStatement методGetSqliteStatementForUpdate(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("rights").intValue());//"uuid"
            sqLiteStatementInsert.bindString(3, jsonNodeParentMAP.get("telephone").asText().trim());//"uuid"
